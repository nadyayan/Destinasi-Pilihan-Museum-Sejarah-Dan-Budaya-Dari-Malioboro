...
var format_Museum_14 = new ol.format.GeoJSON();
var features_Museum_14 = format_Museum_14.readFeatures(json_Museum_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Museum_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Museum_14.addFeatures(features_Museum_14);
var lyr_Museum_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Museum_14, 
                style: style_Museum_14,
                popuplayertitle: 'Museum',
                interactive: true,
                title: '<img src="styles/legend/Museum_14.png" /> Museum'
            });
var format_MalioboroMBatikYogya_15 = new ol.format.GeoJSON();
var features_MalioboroMBatikYogya_15 = format_MalioboroMBatikYogya_15.readFeatures(json_MalioboroMBatikYogya_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MalioboroMBatikYogya_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MalioboroMBatikYogya_15.addFeatures(features_MalioboroMBatikYogya_15);
var lyr_MalioboroMBatikYogya_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MalioboroMBatikYogya_15, 
                style: style_MalioboroMBatikYogya_15,
                popuplayertitle: 'Malioboro - M. Batik Yogya',
                interactive: true,
                title: '<img src="styles/legend/MalioboroMBatikYogya_15.png" /> Malioboro - M. Batik Yogya'
            });
var format_MalioboroMPurbakalaPleret_16 = new ol.format.GeoJSON();
var features_MalioboroMPurbakalaPleret_16 = format_MalioboroMPurbakalaPleret_16.readFeatures(json_MalioboroMPurbakalaPleret_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MalioboroMPurbakalaPleret_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MalioboroMPurbakalaPleret_16.addFeatures(features_MalioboroMPurbakalaPleret_16);
var lyr_MalioboroMPurbakalaPleret_16 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MalioboroMPurbakalaPleret_16, 
                style: style_MalioboroMPurbakalaPleret_16,
                popuplayertitle: 'Malioboro - M. Purbakala Pleret',
                interactive: true,
                title: '<img src="styles/legend/MalioboroMPurbakalaPleret_16.png" /> Malioboro - M. Purbakala Pleret'
            });
var format_MalioboroMPerjuangan_17 = new ol.format.GeoJSON();
var features_MalioboroMPerjuangan_17 = format_MalioboroMPerjuangan_17.readFeatures(json_MalioboroMPerjuangan_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MalioboroMPerjuangan_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MalioboroMPerjuangan_17.addFeatures(features_MalioboroMPerjuangan_17);
var lyr_MalioboroMPerjuangan_17 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MalioboroMPerjuangan_17, 
                style: style_MalioboroMPerjuangan_17,
                popuplayertitle: 'Malioboro - M. Perjuangan',
                interactive: true,
                title: '<img src="styles/legend/MalioboroMPerjuangan_17.png" /> Malioboro - M. Perjuangan'
            });
var format_MalioboroMWahanarata_18 = new ol.format.GeoJSON();
var features_MalioboroMWahanarata_18 = format_MalioboroMWahanarata_18.readFeatures(json_MalioboroMWahanarata_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MalioboroMWahanarata_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MalioboroMWahanarata_18.addFeatures(features_MalioboroMWahanarata_18);
var lyr_MalioboroMWahanarata_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MalioboroMWahanarata_18, 
                style: style_MalioboroMWahanarata_18,
                popuplayertitle: 'Malioboro - M. Wahanarata',
                interactive: true,
                title: '<img src="styles/legend/MalioboroMWahanarata_18.png" /> Malioboro - M. Wahanarata'
            });
var format_MalioboroMSonobudoyo_19 = new ol.format.GeoJSON();
var features_MalioboroMSonobudoyo_19 = format_MalioboroMSonobudoyo_19.readFeatures(json_MalioboroMSonobudoyo_19, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MalioboroMSonobudoyo_19 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MalioboroMSonobudoyo_19.addFeatures(features_MalioboroMSonobudoyo_19);
var lyr_MalioboroMSonobudoyo_19 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MalioboroMSonobudoyo_19, 
                style: style_MalioboroMSonobudoyo_19,
                popuplayertitle: 'Malioboro - M. Sonobudoyo',
                interactive: true,
                title: '<img src="styles/legend/MalioboroMSonobudoyo_19.png" /> Malioboro - M. Sonobudoyo'
            });
var format_MalioboroMVredeburg_20 = new ol.format.GeoJSON();
var features_MalioboroMVredeburg_20 = format_MalioboroMVredeburg_20.readFeatures(json_MalioboroMVredeburg_20, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MalioboroMVredeburg_20 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MalioboroMVredeburg_20.addFeatures(features_MalioboroMVredeburg_20);
var lyr_MalioboroMVredeburg_20 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MalioboroMVredeburg_20, 
                style: style_MalioboroMVredeburg_20,
                popuplayertitle: 'Malioboro - M. Vredeburg',
                interactive: true,
                title: '<img src="styles/legend/MalioboroMVredeburg_20.png" /> Malioboro - M. Vredeburg'
            });

lyr_GoogleMaps_0.setVisible(true);lyr_MalioboroMDiponegoro_1.setVisible(true);lyr_MalioboroMSandi_2.setVisible(true);lyr_MalioboroMYogyaKembali_3.setVisible(true);lyr_MalioboroMPendidikan_4.setVisible(true);lyr_MalioboroMAffandi_5.setVisible(true);lyr_MalioboroDioramaArsipYogya_6.setVisible(true);lyr_MalioboroMWayangKekayon_7.setVisible(true);lyr_Malioboro_8.setVisible(true);lyr_MalioboroMHistoryofJava_9.setVisible(true);lyr_MalioboroCagarBudayaBulurejo_10.setVisible(true);lyr_MalioboroMSoeharto_11.setVisible(true);lyr_MalioboroMUllenSentalu_12.setVisible(true);lyr_MalioboroMBaleAgung_13.setVisible(true);lyr_Museum_14.setVisible(true);lyr_MalioboroMBatikYogya_15.setVisible(true);lyr_MalioboroMPurbakalaPleret_16.setVisible(true);lyr_MalioboroMPerjuangan_17.setVisible(true);lyr_MalioboroMWahanarata_18.setVisible(true);lyr_MalioboroMSonobudoyo_19.setVisible(true);lyr_MalioboroMVredeburg_20.setVisible(true);
var layersList = [lyr_GoogleMaps_0,lyr_MalioboroMDiponegoro_1,lyr_MalioboroMSandi_2,lyr_MalioboroMYogyaKembali_3,lyr_MalioboroMPendidikan_4,lyr_MalioboroMAffandi_5,lyr_MalioboroDioramaArsipYogya_6,lyr_MalioboroMWayangKekayon_7,lyr_Malioboro_8,lyr_MalioboroMHistoryofJava_9,lyr_MalioboroCagarBudayaBulurejo_10,lyr_MalioboroMSoeharto_11,lyr_MalioboroMUllenSentalu_12,lyr_MalioboroMBaleAgung_13,lyr_Museum_14,lyr_MalioboroMBatikYogya_15,lyr_MalioboroMPurbakalaPleret_16,lyr_MalioboroMPerjuangan_17,lyr_MalioboroMWahanarata_18,lyr_MalioboroMSonobudoyo_19,lyr_MalioboroMVredeburg_20];
...
lyr_Museum_14.set('fieldAliases', {'Longitude': 'Longitude', 'Latitude': 'Latitude', 'Lokasi': 'Lokasi', });
lyr_MalioboroMBatikYogya_15.set('fieldAliases', {'DIST_KM': 'DIST_KM', 'DURATION_H': 'DURATION_H', 'PROFILE': 'PROFILE', 'PREF': 'PREF', 'OPTIONS': 'OPTIONS', 'FROM_ID': 'FROM_ID', 'TO_ID': 'TO_ID', });
lyr_MalioboroMPurbakalaPleret_16.set('fieldAliases', {'DIST_KM': 'DIST_KM', 'DURATION_H': 'DURATION_H', 'PROFILE': 'PROFILE', 'PREF': 'PREF', 'OPTIONS': 'OPTIONS', 'FROM_ID': 'FROM_ID', 'TO_ID': 'TO_ID', });
lyr_MalioboroMPerjuangan_17.set('fieldAliases', {'DIST_KM': 'DIST_KM', 'DURATION_H': 'DURATION_H', 'PROFILE': 'PROFILE', 'PREF': 'PREF', 'OPTIONS': 'OPTIONS', 'FROM_ID': 'FROM_ID', 'TO_ID': 'TO_ID', });
lyr_MalioboroMWahanarata_18.set('fieldAliases', {'DIST_KM': 'DIST_KM', 'DURATION_H': 'DURATION_H', 'PROFILE': 'PROFILE', 'PREF': 'PREF', 'OPTIONS': 'OPTIONS', 'FROM_ID': 'FROM_ID', 'TO_ID': 'TO_ID', });
lyr_MalioboroMSonobudoyo_19.set('fieldAliases', {'DIST_KM': 'DIST_KM', 'DURATION_H': 'DURATION_H', 'PROFILE': 'PROFILE', 'PREF': 'PREF', 'OPTIONS': 'OPTIONS', 'FROM_ID': 'FROM_ID', 'TO_ID': 'TO_ID', });
lyr_MalioboroMVredeburg_20.set('fieldAliases', {'DIST_KM': 'DIST_KM', 'DURATION_H': 'DURATION_H', 'PROFILE': 'PROFILE', 'PREF': 'PREF', 'OPTIONS': 'OPTIONS', 'FROM_ID': 'FROM_ID', 'TO_ID': 'TO_ID', });
...
lyr_Museum_14.set('fieldImages', {'Longitude': 'TextEdit', 'Latitude': 'TextEdit', 'Lokasi': 'TextEdit', });
lyr_MalioboroMBatikYogya_15.set('fieldImages', {'DIST_KM': 'TextEdit', 'DURATION_H': 'TextEdit', 'PROFILE': 'TextEdit', 'PREF': 'TextEdit', 'OPTIONS': 'TextEdit', 'FROM_ID': 'TextEdit', 'TO_ID': 'TextEdit', });
lyr_MalioboroMPurbakalaPleret_16.set('fieldImages', {'DIST_KM': 'TextEdit', 'DURATION_H': 'TextEdit', 'PROFILE': 'TextEdit', 'PREF': 'TextEdit', 'OPTIONS': 'TextEdit', 'FROM_ID': 'TextEdit', 'TO_ID': 'TextEdit', });
lyr_MalioboroMPerjuangan_17.set('fieldImages', {'DIST_KM': 'TextEdit', 'DURATION_H': 'TextEdit', 'PROFILE': 'TextEdit', 'PREF': 'TextEdit', 'OPTIONS': 'TextEdit', 'FROM_ID': 'TextEdit', 'TO_ID': 'TextEdit', });
lyr_MalioboroMWahanarata_18.set('fieldImages', {'DIST_KM': 'TextEdit', 'DURATION_H': 'TextEdit', 'PROFILE': 'TextEdit', 'PREF': 'TextEdit', 'OPTIONS': 'TextEdit', 'FROM_ID': 'TextEdit', 'TO_ID': 'TextEdit', });
lyr_MalioboroMSonobudoyo_19.set('fieldImages', {'DIST_KM': 'TextEdit', 'DURATION_H': 'TextEdit', 'PROFILE': 'TextEdit', 'PREF': 'TextEdit', 'OPTIONS': 'TextEdit', 'FROM_ID': 'TextEdit', 'TO_ID': 'TextEdit', });
lyr_MalioboroMVredeburg_20.set('fieldImages', {'DIST_KM': 'TextEdit', 'DURATION_H': 'TextEdit', 'PROFILE': 'TextEdit', 'PREF': 'TextEdit', 'OPTIONS': 'TextEdit', 'FROM_ID': 'TextEdit', 'TO_ID': 'TextEdit', });
...
lyr_Malioboro_8.set('fieldLabels', {'x': 'no label', 'y': 'no label', 'field_3': 'inline label - always visible', });
...
lyr_Museum_14.set('fieldLabels', {'Longitude': 'no label', 'Latitude': 'no label', 'Lokasi': 'inline label - always visible', });
lyr_MalioboroMBatikYogya_15.set('fieldLabels', {'DIST_KM': 'inline label - always visible', 'DURATION_H': 'inline label - always visible', 'PROFILE': 'inline label - always visible', 'PREF': 'no label', 'OPTIONS': 'no label', 'FROM_ID': 'no label', 'TO_ID': 'no label', });
lyr_MalioboroMPurbakalaPleret_16.set('fieldLabels', {'DIST_KM': 'inline label - always visible', 'DURATION_H': 'inline label - always visible', 'PROFILE': 'inline label - always visible', 'PREF': 'no label', 'OPTIONS': 'no label', 'FROM_ID': 'no label', 'TO_ID': 'no label', });
lyr_MalioboroMPerjuangan_17.set('fieldLabels', {'DIST_KM': 'inline label - always visible', 'DURATION_H': 'inline label - always visible', 'PROFILE': 'inline label - always visible', 'PREF': 'no label', 'OPTIONS': 'no label', 'FROM_ID': 'no label', 'TO_ID': 'no label', });
lyr_MalioboroMWahanarata_18.set('fieldLabels', {'DIST_KM': 'inline label - always visible', 'DURATION_H': 'inline label - always visible', 'PROFILE': 'inline label - always visible', 'PREF': 'no label', 'OPTIONS': 'no label', 'FROM_ID': 'no label', 'TO_ID': 'no label', });
lyr_MalioboroMSonobudoyo_19.set('fieldLabels', {'DIST_KM': 'inline label - always visible', 'DURATION_H': 'inline label - always visible', 'PROFILE': 'inline label - always visible', 'PREF': 'no label', 'OPTIONS': 'no label', 'FROM_ID': 'no label', 'TO_ID': 'no label', });
lyr_MalioboroMVredeburg_20.set('fieldLabels', {'DIST_KM': 'inline label - always visible', 'DURATION_H': 'inline label - always visible', 'PROFILE': 'inline label - always visible', 'PREF': 'no label', 'OPTIONS': 'no label', 'FROM_ID': 'no label', 'TO_ID': 'no label', });
lyr_MalioboroMVredeburg_20.on('precompose', function(evt) {
